   ...
   <div className="sdForm">
    ...
    <div className="sdSection"><div className="sdSectionTitle"><b>Material details</b><span>Existing master data auto-fills the known specification.</span></div>
      <div className="sdGrid">
       ...
       <label>Grade<input value={newMaterial?materialGrade:(form.grade??selectedMaterial?.grade??"")} onChange={e=>newMaterial?setMaterialGrade(e.target.value):setForm((f:any)=>({...f,grade:e.target.value}))} placeholder={newMaterial?"e.g. IS 513":"Auto-filled — editable for this record"}/></label>
       <label>Specification<input value={newMaterial?materialSpec:(form.specification??selectedMaterial?.specification??"")} onChange={e=>newMaterial?setMaterialSpec(e.target.value):setForm((f:any)=>({...f,specification:e.target.value}))} placeholder={newMaterial?"e.g. 0.8mm x 1250mm":"Auto-filled — editable for this record"}/></label>
