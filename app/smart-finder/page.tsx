...
export default async function SmartFinderPage(){
  ...
  const [materials,buyers]=await Promise.all([
  ...
  return <main className="modulePage">
    <header className="moduleHeader">
      <div><p className="eyebrow">TRADING DESK</p><h1>Smart Material Finder</h1><p className="muted">Search the centralized seller, opportunity and inventory network to find supply for a buyer requirement.</p></div>
    </header>
    <SmartMaterialFinder materials={materials} buyers={buyers}/>
  </main>;
}